...
typedef bool(__stdcall *create_move)(float, CUserCmd*);
...
void ClanTag()
{
	...
	if (!Interfaces::Engine->IsConnected() || !Interfaces::Engine->IsInGame())
		SetClanTag("SchoolShooter", "SchoolShooter");
	...
	case 1:
	{
		...
		switch (value) {
		case 0:SetClanTag("             ", "SchoolShooter"); break;
		case 1:SetClanTag("SchoolShooter", "SchoolShooter"); break;
		}
		counter++;
	...
	case 2:
	{
		...
		switch (value) {
		case 0:SetClanTag("S-", "SchoolShooter"); break;
		case 1:SetClanTag("Sc", "SchoolShooter"); break;
		case 2:SetClanTag("Sc-", "SchoolShooter"); break;
		case 3:SetClanTag("Sch", "SchoolShooter"); break;
		case 4:SetClanTag("Sch-", "SchoolShooter"); break;
		case 5:SetClanTag("Scho", "SchoolShooter"); break;
		case 6:SetClanTag("Scho-", "SchoolShooter"); break;
		case 7:SetClanTag("Schoo", "SchoolShooter"); break;
		case 8:SetClanTag("Schoo-", "SchoolShooter"); break;
		case 9:SetClanTag("School", "SchoolShooter"); break;
		case 10:SetClanTag("School-", "SchoolShooter"); break;
		case 11:SetClanTag("SchoolS", "SchoolShooter"); break;
		case 12:SetClanTag("SchoolS-", "SchoolShooter"); break;
		case 13:SetClanTag("SchoolSh", "SchoolShooter"); break;
		case 14:SetClanTag("SchoolSh-", "SchoolShooter"); break;
		case 15:SetClanTag("SchoolSho", "SchoolShooter"); break;
		case 16:SetClanTag("SchoolSho-", "SchoolShooter"); break;
		case 17:SetClanTag("SchoolShoo", "SchoolShooter"); break;
		case 18:SetClanTag("SchoolShoo-", "SchoolShooter"); break;
		case 19:SetClanTag("SchoolShoot", "SchoolShooter"); break;
		case 20:SetClanTag("SchoolShoot-", "SchoolShooter"); break;
		case 21:SetClanTag("SchoolShoote", "SchoolShooter"); break;
		case 22:SetClanTag("SchoolShoote-", "SchoolShooter"); break;
		case 23:SetClanTag("SchoolShooter", "SchoolShooter"); break;
	...
	case 4:
		...
		break;
	case 5:
		SetClanTag("EzFrags>All", "EzFrags>All");
	...
	case 7:
	{
		...
		int value = ServerTime % 30;
		switch (value) {
		case 0:SetClanTag(">B-", "Bryce Is Gay"); break;
		case 1:SetClanTag(">Br", "Bryce Is Gay"); break;
		case 2:SetClanTag(">Br-", "Bryce Is Gay"); break;
		case 3:SetClanTag(">Bry", "Bryce Is Gay"); break;
		case 4:SetClanTag(">Bry-", "Bryce Is Gay"); break;
		case 5:SetClanTag(">Bryc", "Bryce Is Gay"); break;
		case 6:SetClanTag(">Bryc-", "Bryce Is Gay"); break;
		case 7:SetClanTag(">Bryce", "Bryce Is Gay"); break;
		case 8:SetClanTag(">Bryce-", "Bryce Is Gay"); break;
		case 9:SetClanTag(">Bryce ", "Bryce Is Gay"); break;
		case 10:SetClanTag(">Bryce -", "Bryce Is Gay"); break;
		case 11:SetClanTag(">Bryce I", "Bryce Is Gay"); break;
		case 12:SetClanTag(">Bryce I-", "Bryce Is Gay"); break;
		case 13:SetClanTag(">Bryce Is", "Bryce Is Gay"); break;
		case 14:SetClanTag(">Bryce Is-", "Bryce Is Gay"); break;
		case 15:SetClanTag(">Bryce Is ", "Bryce Is Gay"); break;
		case 16:SetClanTag(">Bryce Is -", "Bryce Is Gay"); break;
		case 17:SetClanTag(">Bryce Is G", "Bryce Is Gay"); break;
		case 18:SetClanTag(">Bryce Is G-", "Bryce Is Gay"); break;
		case 19:SetClanTag(">Bryce Is Ga", "Bryce Is Gay"); break;
		case 20:SetClanTag(">Bryce Is Ga-", "Bryce Is Gay"); break;
		case 21:SetClanTag(">Bryce Is Gay", "Bryce Is Gay"); break;
		case 22:SetClanTag(">Bryce Is Gay", "Bryce Is Gay"); break;
		case 23:SetClanTag(">Bryce Is Gay", "Bryce Is Gay"); break;
		case 24:SetClanTag(">Bryce Is Gay", "Bryce Is Gay"); break;
		case 25:SetClanTag(">Bryce Is Gay", "Bryce Is Gay"); break;
		case 26:SetClanTag(">Bryce Is Gay", "Bryce Is Gay"); break;
		case 27:SetClanTag(">Is Gay", "Bryce Is Gay"); break;
		case 28:SetClanTag(">Gay", "Bryce Is Gay"); break;
		case 29:SetClanTag(">", "Bryce Is Gay"); break;
		case 30:SetClanTag(">", "Bryce Is Gay"); break;
...
void __fastcall PaintTraverse_Hooked(PVOID pPanels, int edx, unsigned int vguiPanel, bool forceRepaint, bool allowForce)
{
	...
	else if (FocusOverlayPanel == vguiPanel)
	{
			...
			if (Menu::Window.VisualsTab.Watermark.GetState())
			{
				...
				Render::Text(7, 500, Color(80, 140, 240, 255), Render::Fonts::ESP, ("SchoolShooter"));

				char bufferLineLBY[64];
				sprintf_s(bufferLineLBY, "LBY:  %.1f", lineLBY);
				Render::Text(7, 510, Color(255, 255, 255, 255), Render::Fonts::ESP, bufferLineLBY);

				char bufferlineRealAngle[64];
				sprintf_s(bufferlineRealAngle, "Real:  %.1f", lineRealAngle);
				Render::Text(7, 520, Color(255, 255, 255, 255), Render::Fonts::ESP, bufferlineRealAngle);
...
void __fastcall  hkSceneEnd(void *pEcx, void *pEdx) {
	...
	IClientEntity* pLocal = Interfaces::EntList->GetClientEntity(Interfaces::Engine->GetLocalPlayer());
	if (Menu::Window.VisualsTab.FakeAngleChams.GetIndex() == 1 || Menu::Window.VisualsTab.FakeAngleChams.GetIndex() == 3)
	{
		if (pLocal)
		{
			static  IMaterial* CoveredLit = CreateMaterial(true);
	...
	if (Menu::Window.VisualsTab.FakeAngleChams.GetIndex() == 2 || Menu::Window.VisualsTab.FakeAngleChams.GetIndex() == 3)
	{
		if (pLocal)
		{
			static  IMaterial* LbyMeme = CreateMaterial(false, false, true);
			if (LbyMeme)
			{
				Vector OrigAng2;
				OrigAng2 = pLocal->GetEyeAngles();
				pLocal->SetAngle3(Vector(0, pLocal->GetLowerBodyYaw(), 0));

				bool LbyColor = false;
				float LowerColor[3] = { 45, 45, 45 };
				float lbyUpdateColor[3] = { 0, 1, 0 };
				Interfaces::RenderView->SetColorModulation(LbyColor ? lbyUpdateColor : LowerColor);
				Interfaces::ModelRender->ForcedMaterialOverride(LbyMeme);
				pLocal->draw_model2(1, 255);
				Interfaces::ModelRender->ForcedMaterialOverride(nullptr);
				pLocal->SetAngle3(OrigAng2);
			}
		}
	}
}