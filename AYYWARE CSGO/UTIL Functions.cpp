...
void duiwefewfgiyewgdiwf()
{
	float pJunkcode = 269279563;
	pJunkcode = 38585676;
	if (pJunkcode = 596926361)
		pJunkcode = 3159532200;
	pJunkcode = 660030194;
	pJunkcode = 175765079;
	if (pJunkcode = 14128003);
	pJunkcode = 82898677;
	pJunkcode = 3249512930;
	if (pJunkcode = 1059831441)
		pJunkcode = 2546921791;
	pJunkcode = 301972094;
	pJunkcode = 126766891;
	if (pJunkcode = 2411218154);
	pJunkcode = 87832006;
	pJunkcode = 174130509;
	if (pJunkcode = 1086224317)
		pJunkcode = 1040900;
	pJunkcode = 2158325316;
	pJunkcode = 1048625407;
	if (pJunkcode = 1051527391);
	pJunkcode = 2219631768;
	pJunkcode = 706629304;

}

void fewuidyhwiufyweiufew()
{
	float pJunkcode = 181402374;
	pJunkcode = 47592918;
	if (pJunkcode = 393629232)
		pJunkcode = 401928352;
	pJunkcode = 201053405;
	pJunkcode = 3067916428;
	if (pJunkcode = 665821484);
	pJunkcode = 287037460;
	pJunkcode = 1303830192;
	if (pJunkcode = 202124154)
		pJunkcode = 41302865;
	pJunkcode = 611428068;
	pJunkcode = 2267329727;
	if (pJunkcode = 2704422775);
	pJunkcode = 2509511689;
	pJunkcode = 473722579;
	if (pJunkcode = 20757261)
		pJunkcode = 160926144;
	pJunkcode = 285114816;
	pJunkcode = 3021417719;
	if (pJunkcode = 22655952);
	pJunkcode = 228708100;
	pJunkcode = 2706311384;
