...
void CMiscHacks::Crasher()
{
	...
	if (wasSpamming)
	{
		...
		if (useSpace)
		{
			change_name("White People Are School Shooters. White People Are School Shooters. White People Are School Shooters. White People Are School Shooters. White People Are School Shooters. White People Are School Shooters. White People Are School Shooters. White People Are School Shooters.");
			useSpace = !useSpace;
		}
		else
		{
