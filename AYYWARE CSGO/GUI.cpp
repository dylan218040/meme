...
void CGUI::Draw()
{
	...
	if (ShouldDrawCursor)
	{
		...
		for (int i = 0; i < 11; i++)
			Render::Clear(Mouse.x + 2 + i, Mouse.y + 1 + i, 1, 1, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		Render::Clear(Mouse.x + 8, Mouse.y + 12, 5, 1, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		Render::Clear(Mouse.x + 8, Mouse.y + 13, 1, 1, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		Render::Clear(Mouse.x + 9, Mouse.y + 14, 1, 2, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		Render::Clear(Mouse.x + 10, Mouse.y + 16, 1, 2, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		Render::Clear(Mouse.x + 8, Mouse.y + 18, 2, 1, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		Render::Clear(Mouse.x + 7, Mouse.y + 16, 1, 2, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		Render::Clear(Mouse.x + 6, Mouse.y + 14, 1, 2, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		Render::Clear(Mouse.x + 5, Mouse.y + 13, 1, 1, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		Render::Clear(Mouse.x + 4, Mouse.y + 14, 1, 1, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		Render::Clear(Mouse.x + 3, Mouse.y + 15, 1, 1, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		Render::Clear(Mouse.x + 2, Mouse.y + 16, 1, 1, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		for (int i = 0; i < 4; i++)
			Render::Clear(Mouse.x + 2 + i, Mouse.y + 2 + i, 1, 14 - (i * 2), Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		Render::Clear(Mouse.x + 6, Mouse.y + 6, 1, 8, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		Render::Clear(Mouse.x + 7, Mouse.y + 7, 1, 9, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		for (int i = 0; i < 4; i++)
			Render::Clear(Mouse.x + 8 + i, Mouse.y + 8 + i, 1, 4 - i, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		Render::Clear(Mouse.x + 8, Mouse.y + 14, 1, 4, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
		Render::Clear(Mouse.x + 9, Mouse.y + 16, 1, 2, Color(Menu::Window.ColorsTab.ColorMenuAccentR.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentG.GetValue(), Menu::Window.ColorsTab.ColorMenuAccentB.GetValue(), 255));
...
bool CGUI::DrawWindow(CWindow* window)
{
	...
	//Render::Text(window->m_x + 420, window->m_y + 10, Color(255, 255, 255, 255), Render::Fonts::MenuBold, "SS");
